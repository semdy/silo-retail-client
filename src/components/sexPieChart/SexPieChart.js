    ...
    series: [
      {
        ...
        radius: ['45%', '65%'],
        data: data.series,
        color: ["#f39726", '#008cee', '#f05a4b', '#29ab91', '#f05a4b', '#f4b81c', '#30a3b6', '#2a81c4', '#f39a00'],
        label: {
          emphasis: {
...
class SexPieChart extends BaseChart {

  constructor(props) {
    super(props);
    this.queryKey = 'retail.sku.cate.distribute';
    this.chartProps = {
      title: locale.sexDistribution,
      titleCenter: true
    };
  }
